...
class Admin extends Model
{
    ...
    // Валидация логина админа ( Сравнение данных отправленных из форму с конфигами )
    ...
    // Подсчёт истории для пагинации
    public function historyCount()
    {
        return $this->db->column('SELECT COUNT(id) FROM history');
    }

    // Показывает всю историю на сайте
    ...
    // Список заявок на вывод по рефералам
    ...
    // Список заявок на вывод по тарифам
    ...
    // Потвердить выплату по реферелу
